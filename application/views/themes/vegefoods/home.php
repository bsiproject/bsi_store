      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Hanya Sepatu dan Tas Terbaik</h1>
            <h2 class="subheading mb-4">Barang 100% Berkualitas</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            ...
            <h2 class="subheading mb-4">Sepatu dan Tas berkualitas barang import</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/home3.jpg'); ?>);">
  <div class="container">
