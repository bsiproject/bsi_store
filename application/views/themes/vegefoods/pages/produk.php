    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          ...
          <h1 class="mb-0 bread">Produk Penjualan</h1>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/About.png'); ?>);">
                      <a href="https://www.youtube.com/channel/UCgRbHXCfWR-p7L5HacpPAUw" class="icon popup-vimeo d-flex justify-content-center align-items-center">
